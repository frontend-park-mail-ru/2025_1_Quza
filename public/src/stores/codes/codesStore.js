...
class CodesStore {
  ...
  init() {
    ...
    let codes = [
      ...
      },
      {
        ...
        title: 'Mock Code 2',
        content: '0 mb',
        data: ['string21', 'string22', 'string23'],
        create_time: new Date().toISOString(),
        update_time: new Date().toISOString(),
      },
    ];
  ...
  searchCodes(query) {
    ...
    const codes = [
      ...
      {
        id: 3,
        title: `Mock Code 3 (${query})`,
        content: `Mock content 3 (matching ${query})`,
        create_time: new Date().toISOString(),
        update_time: new Date().toISOString(),
      },
    ];
  ...
  loadCodes() {
    ...
    const codes = [
      ...
      {
        id: 4 + this.#offset,
        title: `Mock Code ${4 + this.#offset}`,
        content: `Mock content ${4 + this.#offset} (loaded)`,
        create_time: new Date().toISOString(),
        update_time: new Date().toISOString(),
      },
    ];
  ...
  _convertCodeData(codeData) {
    ...
    return {
      ...
      update_time: new Intl.DateTimeFormat('ru', {
        ...
        .format(new Date(codeData.update_time))
        .replace(',', ''),
    };
  }
}
